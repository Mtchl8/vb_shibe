...
engine = create_engine('postgres://pjnkzjdepbsejw:020908508e47ebd6317f029623231eb3ba17836e6326ee3a3ce6dea900bf741c@ec2-54-195-247-108.eu-west-1.compute.amazonaws.com:5432/d8ug54bgore9n7', echo=True)
...
def send_question(viber_id):
    ...
    if select_query[0] >= settings[0]:
        ...
        return TextMessage(text=f'{select_query[0] + 1}.Выберите верный перевод слова {question["word"]}',
...
def incoming():
    ...
    if isinstance(viber_request, ViberConversationStartedRequest):
        ...
        viber.send_messages(viber_request.user.id, [
            TextMessage(text='Привет! Этот бот предназначен для заучивания английских слов! Нажимай кнопку "СТАРТ"!',
                        keyboard=KEYBOARD1, tracking_data='tracking_data')
        ])
